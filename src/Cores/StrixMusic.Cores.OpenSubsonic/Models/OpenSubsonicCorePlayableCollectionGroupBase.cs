...
public abstract class OpenSubsonicCorePlayableCollectionGroupBase : ICorePlayableCollectionGroup
{
    protected readonly OpenSubsonicCore _sourceCore;
    protected readonly ISubsonicClient _client;
    
    protected OpenSubsonicCorePlayableCollectionGroupBase(OpenSubsonicCore sourceCore)
    {
